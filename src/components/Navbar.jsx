  ...
  return (
    <nav className="bg-[transparent] py-4 fixed w-full z-50 ">
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex-shrink-0">
            <a href="#" className="flex items-center">
             <p className='text-purple-600 text-4xl font-bold'> <span className='text-white'>Dark</span>Stone</p>
            </a>
          </div>
      ...
      <div className={`menu bg-[#cbd3cb] transition-all duration-300 overflow-hidden ${isOpen ? 'max-h-500' : 'max-h-0'} md:hidden `}>
        <a href="/" className="block px-4 py-2 text-gray-700 font-medium hover:text-[green]">Home</a>
        <a href="/about" className="block px-4 py-2 text-gray-700 font-medium hover:text-[green]">About</a>
        <a href="/services" className="block px-4 py-2 text-gray-700 font-medium hover:text-[green]">Services</a>
        <a href="/portfolio" className="block px-4 py-2 text-gray-700 font-medium hover:text-[green]">Portfolio</a>
        <a href="/contact" className="block px-4 py-2 text-gray-700 font-medium hover:text-[green]">Contact</a>
        <a href="#" className="block text-center px-4 py-2 text-gray-700 font-medium hover:text-[green]">
